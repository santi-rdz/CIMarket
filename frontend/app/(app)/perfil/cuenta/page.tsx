...
export default function CuentaPage() {
  ...
  return (
    <Modal>
      <div className="space-y-10 animate-fade-in-up animate-duration-400">
        {/* Avatar + name */}
        ...
        <section>
          ...
          <div className="rounded-2xl border border-slate-100 px-4">
            ...
            />
            <EditableField label="Correo electrónico" value={profile.email} readOnly />
          </div>
        </section>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="txt-6 leading-relaxed text-slate-400">
            ...
            . Se eliminarán tu perfil, publicaciones y datos asociados.
          </p>
        </div>
      </div>
